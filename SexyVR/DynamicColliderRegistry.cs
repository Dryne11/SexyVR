...
namespace SexyVR {
    ...
    class DynamicColliderRegistry {
        ...
        public static void RegisterCollider(
                DynamicBoneCollider collider,
                Predicate<IDynamicBoneWrapper> targetSelector = null) {
        ...
        private static void Correlate(
                IDynamicBoneWrapper bone,
                DynamicBoneCollider collider,
                Predicate<IDynamicBoneWrapper> targetSelector) {
        ...
        public class DynamicBone_CustomWrapper : IDynamicBoneWrapper {
            ...
            public Transform Root {
                get {
                    return (Bone as DynamicBone_Custom).m_Nodes[0].Transform;
                }
            }

            public Transform Rim {
                get {
                    return (Bone as DynamicBone_Custom).m_Nodes.Last().Transform;
                }
            }

            public IEnumerable<Transform> Nodes {
                get {
                    return (Bone as DynamicBone_Custom).m_Nodes.Select(nodes => nodes.Transform);
                }
            }
